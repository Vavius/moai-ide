--============================================================================--
-- Table serialization and pretty printer (serpent)
--============================================================================--
...
pretty = function(a, opts) return s(a, merge({indent = '  ', sortkeys = true, comment = true, nocode = true, keyignore = ignoredKeys}, opts)) end
}
