...
class Ui_particleEditor(object):
    def setupUi(self, particleEditor):
        ...
        self.lblColor.setMinimumSize(QtCore.QSize(0, 26))
        self.lblColor.setScaledContents(False)
        self.lblColor.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lblColor.setMargin(0)
        ...
        self.lblColor.setBuddy(self.btnBgColor)
