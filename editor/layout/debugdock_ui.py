...
class Ui_debugdock(object):
    def setupUi(self, debugdock):
        ...
        self.runStringLocalBtn = QtGui.QPushButton(self.dockWidgetContents)
        self.runStringLocalBtn.setObjectName("runStringLocalBtn")
        self.gridLayout.addWidget(self.runStringLocalBtn, 21, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupBox, 17, 1, 1, 2)
        self.runStringDeviceBtn = QtGui.QPushButton(self.dockWidgetContents)
        self.runStringDeviceBtn.setObjectName("runStringDeviceBtn")
        self.gridLayout.addWidget(self.runStringDeviceBtn, 21, 2, 1, 1)
        spacerItem2 = QtGui.QSpacerItem(20, 319, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem2, 22, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.luaStringEdit, 20, 1, 1, 2)
        spacerItem3 = QtGui.QSpacerItem(124, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem3, 17, 3, 1, 1)
        self.label = QtGui.QLabel(self.dockWidgetContents)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 19, 1, 1, 1)
        self.screenshotBtn = QtGui.QPushButton(self.dockWidgetContents)
        self.screenshotBtn.setObjectName("screenshotBtn")
        self.gridLayout.addWidget(self.screenshotBtn, 18, 1, 1, 1)
        ...
        QtCore.QObject.connect(self.runStringLocalBtn, QtCore.SIGNAL("clicked()"), debugdock.runStringLocal)
        QtCore.QObject.connect(self.runStringDeviceBtn, QtCore.SIGNAL("clicked()"), debugdock.runStringDevice)
        QtCore.QObject.connect(self.screenshotBtn, QtCore.SIGNAL("clicked()"), debugdock.takeScreenshot)
    ...
    def retranslateUi(self, debugdock):
        ...
        self.runStringLocalBtn.setText(QtGui.QApplication.translate("debugdock", "Local", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.runStringDeviceBtn.setText(QtGui.QApplication.translate("debugdock", "Device", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("debugdock", "Run String:", None, QtGui.QApplication.UnicodeUTF8))
        self.screenshotBtn.setText(QtGui.QApplication.translate("debugdock", "Take Screenshot", None, QtGui.QApplication.UnicodeUTF8))
